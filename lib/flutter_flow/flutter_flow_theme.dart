...
class ThemeTypography extends Typography {
  ...
  TextStyle get displayLarge => GoogleFonts.leagueSpartan(
  ...
  TextStyle get displayMedium => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 44.0,
      );
  ...
  TextStyle get displaySmall => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 36.0,
      );
  ...
  TextStyle get headlineLarge => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 32.0,
      );
  ...
  TextStyle get headlineMedium => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 28.0,
      );
  ...
  TextStyle get headlineSmall => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 24.0,
      );
  ...
  TextStyle get titleLarge => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 20.0,
      );
  ...
  TextStyle get titleMedium => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 18.0,
      );
  ...
  TextStyle get titleSmall => GoogleFonts.leagueSpartan(
        color: theme.primaryText,
        fontWeight: FontWeight.w600,
        fontSize: 16.0,
      );
