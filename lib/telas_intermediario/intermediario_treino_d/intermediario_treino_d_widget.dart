...
import 'intermediario_treino_d_model.dart';
export 'intermediario_treino_d_model.dart';

class IntermediarioTreinoDWidget extends StatefulWidget {
  const IntermediarioTreinoDWidget({super.key});

  static const String routeName = 'intermediarioTreinoD';
  static const String routePath = '/intermediarioTreinoD';

  @override
  State<IntermediarioTreinoDWidget> createState() => _IntermediarioTreinoDWidgetState();
}

class _IntermediarioTreinoDWidgetState extends State<IntermediarioTreinoDWidget> {
  late IntermediarioTreinoDModel _model;
  late Timer _timer;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntermediarioTreinoDModel());
