...
import 'intermediario_treino_c_model.dart';
export 'intermediario_treino_c_model.dart';

class IntermediarioTreinoCWidget extends StatefulWidget {
  const IntermediarioTreinoCWidget({super.key});

  static const String routeName = 'intermediarioTreinoC';
  static const String routePath = '/intermediarioTreinoC';

  @override
  State<IntermediarioTreinoCWidget> createState() =>
      _IntermediarioTreinoCWidgetState();
}

class _IntermediarioTreinoCWidgetState extends State<IntermediarioTreinoCWidget> {
  late IntermediarioTreinoCModel _model;
  late Timer _timer;
  Duration _elapsed = Duration.zero;

  // Lista com 6 blocos de exercício (dados fixos, ajuste conforme banco de dados)
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntermediarioTreinoCModel());

    // Inicializa controladores de carga
