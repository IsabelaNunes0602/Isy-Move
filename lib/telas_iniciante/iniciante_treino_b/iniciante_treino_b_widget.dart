...
import 'iniciante_treino_b_model.dart';
export 'iniciante_treino_b_model.dart';

class InicianteTreinoBWidget extends StatefulWidget {
  const InicianteTreinoBWidget({super.key});

  static const String routeName = 'inicianteTreinoB';
  static const String routePath = '/inicianteTreinoB';

  @override
  State<InicianteTreinoBWidget> createState() => _InicianteTreinoBWidgetState();
}

class _InicianteTreinoBWidgetState extends State<InicianteTreinoBWidget> {
  late InicianteTreinoBModel _model;
  late Timer _timer;
  Duration _elapsed = Duration.zero;

  // Lista com 6 blocos de exercício, dados fixos (serie e repetições)
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicianteTreinoBModel());
  ...
  void _salvarCarga(int id) {
    ...
    // Aqui implemente a persistência/atualização da carga
