...
import 'iniciante_treino_a_model.dart';
export 'iniciante_treino_a_model.dart';

class InicianteTreinoAWidget extends StatefulWidget {
  const InicianteTreinoAWidget({super.key});

  static const String routeName = 'inicianteTreinoA';
  static const String routePath = '/inicianteTreinoA';

  @override
  State<InicianteTreinoAWidget> createState() => _InicianteTreinoAWidgetState();
}

class _InicianteTreinoAWidgetState extends State<InicianteTreinoAWidget> {
  late InicianteTreinoAModel _model;
  late Timer _timer;
  Duration _elapsed = Duration.zero;

  // Lista com 6 blocos de exercício
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InicianteTreinoAModel());
  ...
  void _salvarCarga(int id) {
    ...
    // Aqui implemente persistência da carga se necessário
        ...
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              ...
              color: Color(0xFF8910F0), // Roxo destacado
            ),
